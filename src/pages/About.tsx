              ...
              <div>
                ...
                <div className="space-y-8">
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    ...
                    complex problems and create meaningful experiences. With a
                    background in software development and a passion for
                    innovation, I have dedicated myself to mastering the tools
                    and techniques that drive the future of AI.
                  </p>

                  <p className="text-lg text-muted-foreground leading-relaxed">
                    Starting from building simple HTML websites to developing
                    complex AI-driven applications, my journey has been one of
                    continuous learning and growth.
                  </p>

                  <p className="text-lg text-muted-foreground leading-relaxed">
                    Began coding basic HTML code around 2005, my path has
                    expanded to building effective UI frontends, backends,
                    database developments, working with CMS such as Sharepoint,
                    dynamic JavaScript frameworks, and cloud development. Each
                  ...
                  <div className="space-y-6">
                    <div className="border-l-2 border-architectural pl-6">
                      ...
                      <p className="text-muted-foreground">
                        Keeping up with latest technologies and best practices
                      </p>
                    </div>
                    <div className="border-l-2 border-architectural pl-6">
                      ...
                      <p className="text-muted-foreground">
                        Working closely with clients and team members to ensure
                    ...
                    <div className="border-l-2 border-architectural pl-6">
                      ...
                      <p className="text-muted-foreground">
                        Sharpen skills through consistent practice and
                        experimentation
                      </p>
                    </div>
                  </div>
