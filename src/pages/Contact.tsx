          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-2 gap-20">
              <div>
                ...
                <div
                  className="contactbox space-y-8 p-6 drop-shadow-lg 
                bg-shadow-lg rounded-lg dark:border-none"
                >
              ...
              <div className="p-8 rounded-lg">
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="w-full bg-primary text-white dark:bg-black py-2 px-4 rounded hover:bg-primary-dark transition-colors duration-300"
                  >
                    Send Message
                  </button>
                  {status && (
