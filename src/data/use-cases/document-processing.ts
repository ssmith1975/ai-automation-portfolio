...
import documentProcessingErrorHandlingThumbnail from "@/assets/document-processing/workflow-document-processing-error-handling.png";
import documentProcessingLoggingThumbnail from "@/assets/document-processing/workflow-document-processing-logging.png";

// JSON Workflow file paths
const documentProcessingWorkflow = "/json-workflows/document-processing/workflow-document-processing.json";
const documentProcessingWorkflowErrorHandling  = "/json-workflows/document-processing/workflow-document-processing-error-handling.json";
const documentProcessingWorkflowLogging  = "/json-workflows/document-processing/workflow-document-processing-logging.json";
...
export {
    ...
    useCaseAsIsProcessMapping,
    useCaseProposedMapping,
