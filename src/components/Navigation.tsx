      ...
      <div className="container mx-auto px-6 py-4 flex items-center justify-between">
        <div className="text-minimal text-foreground">
          <a href="/" className="hover:text-muted-foreground transition-colors duration-300 cursor-pointer">
            <svg id="logo"  viewBox="0 0 300 80"  width={300} height={80} className="inline-block mr-2 text-foreground logo hover:text-sky-600 transition-colors duration-300"
            >
              ...
              <text x="75" y="48" font-family="Arial, sans-serif" font-size="28" font-weight="bold" fill="currentColor">ssmith-ai</text>
        ...
        <div className="hidden md:flex items-center space-x-12">
          <a href="/" className="text-minimal text-muted-foreground hover:text-foreground transition-colors duration-300 dark:text-sky-200" aria-label="Home">
            HOME
          </a>
          <a href="/#services" className="text-minimal text-muted-foreground hover:text-foreground transition-colors duration-300 dark:text-sky-200" aria-label="Services">
            SERVICES
          </a>
          <a href="/use-cases" className="text-minimal text-muted-foreground hover:text-foreground transition-colors duration-300 dark:text-sky-200" aria-label="Use Cases">
            USE CASES
          </a>
          <a href="/workflows" className="text-minimal text-muted-foreground hover:text-foreground transition-colors duration-300 dark:text-sky-200" aria-label="Workflows">
            WORKFLOWS
          </a>

          <a href="/about" className="text-minimal text-muted-foreground hover:text-foreground transition-colors duration-300 dark:text-sky-200" aria-label="About">
            ABOUT
          </a>
          {/* <a href="/blog" className="text-minimal text-muted-foreground hover:text-foreground transition-colors duration-300">
            BLOG
          </a> */}
          <a href="/contact" className="text-minimal text-muted-foreground hover:text-foreground transition-colors duration-300 dark:text-sky-200" aria-label="Contact">
            CONTACT
          </a>
        </div>
