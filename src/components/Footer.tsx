    ...
    return (
        <footer className="bg-background text-center py-6 mt-12 border-t border-border">
            <div className="mb-4">
                <a
                    href="/"
                    className="text-minimal text-muted-foreground hover:text-foreground transition-colors duration-300 mx-2 dark:text-sky-200"
                >
                    HOME
                </a>
                <a
            ...
            <p className="text-sm text-muted-foreground">
                &copy; {new Date().getFullYear()} ssmith-ai. All rights
                reserved.
            </p>
        </footer>
    )
